 ...
 * @author hp
 */
public class E_SummaryOfRequest_Healthy_5Controller implements Initializable {
   private Stage stage;
   private Scene scene;
   private Parent root;
    /**
    ...
    //btn 
      @FXML
    public void MakeArequestHealthy(ActionEvent event) throws IOException{
        
      Parent root = FXMLLoader.load(getClass().getResource("E_Confirmation_Healthy_6.fxml"));

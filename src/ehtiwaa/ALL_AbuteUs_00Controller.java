 ...
 * @author hp
 */
public class ALL_AbuteUs_00Controller implements Initializable {
   private Stage stage;
   private Scene scene;
   private Parent root;
    /**
     ...
     */
   @FXML
   private Button HomePgebtn;
   
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
    } 
    public void EnterToHomepage(ActionEvent event) {
   // parent Homepage = FXMLoader.load(getClass().getResource(""))
    }
         //bar buttons
    //main icon
     @FXML

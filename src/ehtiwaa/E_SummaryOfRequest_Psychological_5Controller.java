 ...
 * @author hp
 */
public class E_SummaryOfRequest_Psychological_5Controller implements Initializable {
   private Stage stage;
   private Scene scene;
   private Parent root;
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       @FXML
    public void MakeArequestPsychological(ActionEvent event) throws IOException{
        
      Parent root = FXMLLoader.load(getClass().getResource("E_Confirmation_Psychological_6.fxml"));
